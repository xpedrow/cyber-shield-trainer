...
const loginSites: LoginSite[] = [
  ...
  },
  {
    ...
    isFake: false,
    redFlags: [],
    explanation: "Este é o login legítimo do PayPal. O domínio oficial utilizado pela empresa é paypal.com, sempre com HTTPS e certificado válido.",
  },
  {
    id: "paypal-fake1",
    name: "PayPal",
    ...
    isFake: true,
    redFlags: [
      "Domínio 'paypal-secure-login.co' não pertence ao PayPal",
      "Uso de palavras como 'secure' ou 'verify' para parecer legítimo",
      "Domínio .co em vez de .com",
      "Possível tentativa de captura de credenciais",
    ],
    explanation: "Página falsa! O PayPal utiliza apenas domínios oficiais como paypal.com. Golpistas frequentemente criam domínios semelhantes para roubar credenciais.",
  },
  {
    id: "netflix-real",
    name: "Netflix",
    ...
    isFake: false,
    redFlags: [],
    explanation: "Este é o login legítimo da Netflix. O domínio oficial é netflix.com e qualquer autenticação ocorre dentro desse endereço.",
  },
  {
    id: "netflix-fake",
    name: "Netflix",
    ...
    isFake: true,
    redFlags: [
      "Domínio 'netflix-login-support.net' não é oficial",
      "Uso de palavras extras para imitar o serviço",
      "Domínio .net em vez de .com",
      "Possível página de captura de senha",
    ],
    explanation: "Página falsa! A Netflix não usa domínios alternativos para login. Golpistas criam URLs semelhantes para enganar usuários.",
  },
  {
    id: "amazon-real",
    name: "Amazon",
    ...
    isFake: false,
    redFlags: [],
    explanation: "Este é o login oficial da Amazon. O domínio amazon.com é usado para autenticação e gerenciamento de contas.",
  },
  {
    id: "amazon-fake",
    name: "Amazon",
    ...
    isFake: true,
    redFlags: [
      "Domínio 'amazon-verification-login.info' não é oficial",
      "Uso de palavras como 'verification' para induzir urgência",
      "Domínio .info suspeito",
      "Possível tentativa de roubo de senha",
    ],
    explanation: "Página falsa! A Amazon nunca solicita login em domínios externos. Sempre verifique se a URL termina em amazon.com.",
  },
  {
    id: "facebook-real",
    name: "Facebook",
    ...
    isFake: false,
    redFlags: [],
    explanation: "Este é o login legítimo do Facebook. A autenticação ocorre no domínio facebook.com ou subdomínios oficiais.",
  },
  {
    id: "facebook-fake",
    name: "Facebook",
    ...
    isFake: true,
    redFlags: [
      "Domínio .ru não pertence ao Facebook",
      "URL tenta parecer um sistema de segurança",
      "Domínio diferente do oficial facebook.com",
      "Possível captura de credenciais",
    ],
    explanation: "Página falsa! O Facebook não usa domínios estrangeiros para login. Esse tipo de URL é frequentemente usado em ataques de phishing.",
  }
];
